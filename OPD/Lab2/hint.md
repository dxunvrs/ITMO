...
Цикл выборки команды: IP->BR,AR BR+1->IP MEM(AR)->DR DR->CR  
Цикл выборки операнда: -  
Цикл выполнения: STOP  

2. Очистка аккумулятора CLA 0200  
Цкил выборки команды: IP->BR,AR BR+1->IP MEM(AR)->DR DR->CR  
Цикл выборки операнда: -  
...
Цикл выборки команды: IP->BR,AR BR+1->IP MEM(AR)->DR DR->CR  
Цикл выборки операнда: -  
Цикл выполнения: AC->DR AC+DR->AC,N,Z,V,C  
...
Цикл выборки команды: IP->BR,AR BR+1->IP MEM(AR)->DR DR->CR  
Цикл выборки операнда: DR->AR MEM(AR)->DR  
Цикл выполнения: ~AC & ~DR->BR ~BR->AC,N,Z,V  
...
> Если чуть-чуть подумать то через два JUMP можно сделать обычный while, но явно не в час ночи)
...
Цикл выборки команды: IP->BR,AR BR+1->IP MEM(AR)->DR DR->CR  
Цикл выборки операнда: DR->AR MEM(AR)->DR  
Цикл выполнения: DR->BR AC->DR BR->AC,N,Z,V DR->MEM(AR)  
...
Цикл выборки команды: IP->BR,AR BR+1->IP MEM(AR)->DR DR->CR  
Цикл выборки операнда: DR->AR MEM(AR)->DR  
Цикл выполнения: DR->BR IP->DR BR->IP ~0+SP->SP,AR DR->MEM(AR)  

12. Сохранение ST EXXX  
Цикл выборки команды: IP->BR,AR BR+1->IP MEM(AR)->DR DR->CR  
Цикл выборки операнда: -  
Цикл выполнения: DR->AR AC->DR DR->MEM(AR)