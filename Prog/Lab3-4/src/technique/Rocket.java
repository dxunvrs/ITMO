...
public final class Rocket extends Device {
    ...
    public Rocket(String name, Engine engine, SpaceObject target) {
    ...
    public Rocket(String name, Engine engine) {
        this(name, engine, SpaceObject.MOON);
    }
    ...
    public void setTarget(SpaceObject newTarget) throws TargetFarAwayException {
